...
class MplNotice extends BaseMVPView {
  constructor (props) {
    super(props)
    this.state = {
      disableSubmit : false,
  ...
  isAgree (tranId, isAgree, benId, spouseAway) {
    this.presenter.updateNoticeMpl(tranId, isAgree, benId, spouseAway)
  }
...
export default ConnectView(MplNotice, Presenter)
