            ...
            <div>
              <Card key = {key}>
                <div className = { 'request-card-grid-option' }>
                  ...
                  <div>
                      <h2 className = { 'font-size-16px font-weight-lighter margin-bottom' }></h2>
                      <h2 className = { 'font-size-16px font-weight-lighter margin-bottom text-align-center' }>{ '>>>' }</h2>
                      <h2 className = { 'font-size-16px font-weight-lighter text-align-center' }>{ '<<<' }</h2>
                  </div>
                  <div>
