      ...
      <div className={'slider'}>
        ...
        <div className={'slider__inner'}>
          <div className={'slider__contents'}>
            <img src = { require('../../images/carousel/Slide1.PNG') }/>
            <br/>
          ...
          <div className={'slider__contents'}>
            <img src = { require('../../images/carousel/Slide2.PNG') }/>
            <br/>
            <div className={'carousel-function'}>
          ...
          <div className={'slider__contents'}>
            <img src = { require('../../images/carousel/Slide3.PNG') }/>
            <br/>
            <div className={'carousel-function'}>
              <GenericButton text = { 'Previous' }
                onClick = { () => this.setState({ selectedSlide : 'second' })}
          ...
          <div className={'slider__contents'}>
            <img src = { require('../../images/carousel/Slide4.PNG') }/>
            <br/>
            <div className={'carousel-function'}>
              <GenericButton text = { 'Previous' }
                onClick = { () => this.setState({ selectedSlide : 'third' })}
          ...
          <div className={'slider__contents'}>
            <img src = { require('../../images/carousel/Slide5.PNG') }/>
            <br/>
            <div className={'carousel-function'}>
              <GenericButton text = { 'Previous' }
                onClick = { () => this.setState({ selectedSlide : 'fourth' })}
