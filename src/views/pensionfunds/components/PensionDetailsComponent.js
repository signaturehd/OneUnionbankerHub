    ...
    return (
      <div className = { 'funds-grid-details-income unionbank-white-color' }>
        <div
          ...
          <h4 className = { 'font-weight-normal font-size-18px' }>{ format(pensionContributionData && pensionContributionData.totalUnitsBought) }</h4>
          <div>
            <p style = {{
              margin: '10px 0px 0px',
              display: 'flex',
        ...
        <div
          ...
          className = { 'funds-grid-row-details line-spacing-2' }>
          <h4 className = { 'font-weight-normal font-size-18px' }>{ format(pensionContributionData && pensionContributionData.totalInvestments) }</h4>
          <div>
            <p style = {{
              margin: '10px 0px 0px',
              display: 'flex',
        ...
        <div
          className = { 'funds-grid-row-details  line-spacing-2' }>
          <h4 className = { 'font-weight-normal font-size-18px' }>{ format(pensionContributionData && pensionContributionData.unitToday) }</h4>
          <div>
            <p style = {{
              margin: '10px 0px 0px',
              display: 'flex',
