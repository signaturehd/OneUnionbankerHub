...
class EducationGrantAidReviewModal extends Component {
  constructor (props) {
    super (props)
    this.state = {
      disableSubmit : false,
...
EducationGrantAidReviewModal.propTypes = {
  onClose : PropTypes.func,
  details : PropTypes.func,
  confirm : PropTypes.string,
  cancel : PropTypes.string,
}
EducationGrantAidReviewModal.defaultProps = {
  confirm : 'Agree',
  cancel : 'Disagree',
}

export default EducationGrantAidReviewModal
