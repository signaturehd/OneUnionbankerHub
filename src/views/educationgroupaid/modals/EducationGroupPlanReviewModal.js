...
class EducationGroupPlanReviewModal extends Component {
...
EducationGroupPlanReviewModal.propTypes={
  onClose : PropTypes.func,
  details : PropTypes.func,
  confirm : PropTypes.string,
  cancel : PropTypes.string,
}
EducationGroupPlanReviewModal.defaultProps={
  confirm : 'Agree',
  cancel : 'Disagree',
}

export default EducationGroupPlanReviewModal
