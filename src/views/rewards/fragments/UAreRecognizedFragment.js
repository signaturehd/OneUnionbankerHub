          ...
          return(
            <div className = {'celebrate-container'}>
              ...
              <div className={'celebrate-container-space text-align-center '}>
                <h1 className={'celebrate-margin-bottom'}>U Are Recognized</h1>
              </div>
                  <h4 className={'font-weight-bold celebrate-container-space text-align-justify celebrate-margin-bottom'}>Given to individuals or teams who demonstrated any component of the UnionBank DNA in their day-to-day task.</h4>
                <div>
