              ...
              <div
                ...
                <div
                  style = {{
                   ...
                   <br/>
                 <div className = { 'neo-details-content-grid' }>
                   <MultipleAvatar
                     width = { '30px' }
                     height = { '30px' }
                     fontSize = { '8' }
                     ...
                     avatarCountBool = { true }
                     margin = { '0 0 0 -10px' }
                     backgroundColor = { 'black' }
                     borderColor = { '2px solid #fff' }
                   />
                   <span className = { `neo-heart-details-comments neo-heart-notactive` }/>
